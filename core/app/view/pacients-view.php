...
<div class="card">
  ...
  <div class="card-content table-responsive">
	<a href="index.php?view=pacientenuevo" class="btn btn-default"><i class='fa fa-male'></i> Nuevo Estudiante</a>
		<?php
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<td><?php echo $user->traumaticos; ?></td>
				<td><?php echo $user->medico; ?></td>

				
				
				<td style="width:280px;">
				<a href="index.php?view=verpacient&id=<?php echo $user->id;?>" class="btn btn-info btn-xs">Ver</a>	
			...
			echo "<p class='alert alert-danger'>No hay Estudiantes</p>";
		}
